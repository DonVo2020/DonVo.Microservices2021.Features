using DonVo.MessagingService.API.Models.Auth;
using DonVo.MessagingService.API.Models.Common;
...
namespace DonVo.MessagingService.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Register(RegisterRequest request)
        {
            ...
            try
            {
                ...
                var account = accountRepository.Create(new Domain.Model.AccountModel
                {
